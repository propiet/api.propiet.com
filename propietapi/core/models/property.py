...
class Property(models.Model):
    ...
    square_meters = models.IntegerField(blank=True, null=True, default=None, verbose_name=_('Square Meters'))
    total_covered_meters = models.IntegerField(blank=True, null=True, default=None, verbose_name=_('Total Covered Meters'))
    total_uncovered_meters = models.IntegerField(blank=True, null=True, default=None, verbose_name=_('Total Uncovered Meters'))
    ...
    expenses = models.IntegerField(blank=True, null=True, default=None, verbose_name=_('Expenses'))
    ...
    roofHeight = models.IntegerField(blank=True, null=True, default=None, verbose_name=_('Roof Height'))
    gateType = models.CharField(blank=True, max_length=1, choices=GATE_TYPE, default=0, verbose_name=_('Gate Type'))
    frontGround = models.IntegerField(blank=True, null=True, default=None, verbose_name=_('Front Ground'))
    largeGround = models.IntegerField(blank=True, null=True, default=None, verbose_name=_('Large Ground'))
    hectares = models.IntegerField(blank=True, null=True, default=None, verbose_name=_('Hectares'))
    fot = models.IntegerField(blank=True, null=True, default=None, verbose_name=_('FOT'))
    fos = models.IntegerField(blank=True, null=True, default=None, verbose_name=_('FOS'))
