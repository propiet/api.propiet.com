...
class Post(models.Model):
    ...
    agent = models.ForeignKey(User, verbose_name=_('Agent'), related_name='post_agent', default=None, blank=True,
                              null=True)
    ...
    map_image_url = models.URLField(verbose_name=_('Map Image Url'), max_length=500, default=None, blank=True,
                                    null=True)
