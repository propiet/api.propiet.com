...
class UserProfile(models.Model):
    ...
    area_code = models.IntegerField(blank=True, null=True, max_length=10, verbose_name=_('Area Code'))
    ...
    activation_key = models.CharField(max_length=40, blank=True, null=True, default=None,
