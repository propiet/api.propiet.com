...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Property.deliveryYear'
        db.alter_column('core_property', 'deliveryYear', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Property.stage'
        db.alter_column('core_property', 'stage', self.gf('django.db.models.fields.CharField')(max_length=1))

        # Changing field 'Property.gateType'
        db.alter_column('core_property', 'gateType', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'Property.deliveryYear'
        db.alter_column('core_property', 'deliveryYear', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=1))

        # Changing field 'Property.stage'
        db.alter_column('core_property', 'stage', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=1))

        # Changing field 'Property.gateType'
        db.alter_column('core_property', 'gateType', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=1))
