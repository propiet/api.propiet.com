...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Ph.quantityBuildingLifts'
        db.delete_column('core_property_ph', 'quantityBuildingLifts')


        # Changing field 'UserProfile.phone'
        db.alter_column('core_user_profile', 'phone', self.gf('django.db.models.fields.TextField')(max_length=40))
        # Adding field 'Post.agent'
        db.add_column('core_post', 'agent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='post_agent', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Ph.quantityBuildingLifts'
        db.add_column('core_property_ph', 'quantityBuildingLifts',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'UserProfile.phone'
        db.alter_column('core_user_profile', 'phone', self.gf('django.db.models.fields.IntegerField')(max_length=10))
        # Deleting field 'Post.agent'
        db.delete_column('core_post', 'agent_id')
