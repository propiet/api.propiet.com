...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.agency_name'
        db.add_column('core_user_profile', 'agency_name',
                      self.gf('django.db.models.fields.TextField')(default=None, max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.agency_name'
        db.delete_column('core_user_profile', 'agency_name')
    ...
    models = {
        ...
        'core.property': {
            ...
            'total_meters': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        'core.userprofile': {
            ...
            'agency_name': ('django.db.models.fields.TextField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
