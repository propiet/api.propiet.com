...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Garage.garageCoverage'
        db.alter_column('core_property_garage', 'garageCoverage', self.gf('django.db.models.fields.IntegerField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'Garage.garageCoverage'
        db.alter_column('core_property_garage', 'garageCoverage', self.gf('django.db.models.fields.FloatField')())
