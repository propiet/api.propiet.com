...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Property.total_meters'
        db.delete_column(u'core_property', 'total_meters')

        # Deleting field 'Property.buildingCondition'
        db.delete_column(u'core_property', 'buildingCondition')

        # Adding field 'Property.total_covered_meters'
        db.add_column('core_property', 'total_covered_meters',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Property.total_meters'
        db.add_column(u'core_property', 'total_meters',
                      self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Property.buildingCondition'
        db.add_column(u'core_property', 'buildingCondition',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, max_length=1, blank=True),
                      keep_default=False)

        # Deleting field 'Property.total_covered_meters'
        db.delete_column('core_property', 'total_covered_meters')
