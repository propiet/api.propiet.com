...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_property', 'antiqueness', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=1, null=True))
    ...
    models = {
        ...
        'core.property': {
            ...
            'antiqueness': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0', 'max_length': '1', 'null': 'True', 'blank': 'True'}),
