...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.hidden_note'
        db.add_column('core_post', 'hidden_note',
                      self.gf('django.db.models.fields.TextField')(default=None, max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.hidden_note'
        db.delete_column('core_post', 'hidden_note')
