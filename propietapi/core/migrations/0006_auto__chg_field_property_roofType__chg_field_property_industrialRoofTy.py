...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Property.roofType'
        db.alter_column('core_property', 'roofType', self.gf('django.db.models.fields.IntegerField')(max_length=1))

        # Changing field 'Property.industrialRoofType'
        db.alter_column('core_property', 'industrialRoofType', self.gf('django.db.models.fields.IntegerField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'Property.roofType'
        db.alter_column('core_property', 'roofType', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=1))

        # Changing field 'Property.industrialRoofType'
        db.alter_column('core_property', 'industrialRoofType', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=1))
    ...
    models = {
        ...
        'core.property': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'deliveryYear': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0', 'max_length': '1', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True', 'db_index': 'True'}),
            'industrialRoofType': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1', 'blank': 'True'}),
            ...
            'roofType': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1', 'blank': 'True'}),
            ...
            'stage': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '0', 'max_length': '1', 'blank': 'True'}),
        ...
        'core.userprofile': {
            ...
            'activation_key': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '40'}),
            'agency_name': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'key_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'None'}),
