...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Department.garageCoverage'
        db.alter_column('core_property_department', 'garageCoverage', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Shed.garageCoverage'
        db.alter_column('core_property_shed', 'garageCoverage', self.gf('django.db.models.fields.IntegerField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'Department.garageCoverage'
        db.alter_column('core_property_department', 'garageCoverage', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Shed.garageCoverage'
        db.alter_column('core_property_shed', 'garageCoverage', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'core.department': {
            ...
            'expenses': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'floorNumber': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'garageCoverage': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'lightness': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
            'orientation': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
            'property_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.Property']", 'unique': 'True', 'primary_key': 'True'}),
            ...
            'quantityElevators': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
            'quantityGarages': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
            'suitableProfessional': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1', 'blank': 'True'}),
        ...
        'core.garage': {
            ...
            'expenses': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'garageCoverage': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
            'property_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.Property']", 'unique': 'True', 'primary_key': 'True'})
        },
        'core.house': {
        ...
        'core.shed': {
            ...
            'garageCoverage': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1', 'blank': 'True'}),
            'gateType': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
            'industrialRoofType': ('django.db.models.fields.IntegerField', [], {'default': '0', 'max_length': '1'}),
