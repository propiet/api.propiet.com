...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Alert.name'
        db.delete_column('core_alert', 'name')

        # Adding field 'Alert.alert_type'
        db.add_column('core_alert', 'alert_type',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Alert.name'
        raise RuntimeError("Cannot reverse this migration. 'Alert.name' and its values cannot be restored.")
        # Deleting field 'Alert.alert_type'
        db.delete_column('core_alert', 'alert_type')
